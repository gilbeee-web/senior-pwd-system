<div class="flex flex-col gap-y-3">
    ...
    <div class="flex gap-x-5">
        ...
        <div class="mt-3 flex flex-col gap-y-1">
            ...
            <select name="educational_attainment" class="border rounded p-2">
...
<div class="flex flex-col">
    ...
    <h1 class="text-xl font-bold">PWD information</h1>
    ...
    <div class="mt-3 flex flex-col gap-y-1">
        ...
        {{-- <select name="blood_type" id="" class="border rounded p-2">
        ...
        <select name="blood_type" id="blood_type" class="border rounded p-2">
            @foreach([
                ...
                <option 
                    value="{{ $blood_type }}"
                    {{ old('disability_type', $pwd->blood_type ?? '') == $blood_type ? 'selected' : '' }}
                >
                    {{ $blood_type }}
                </option>
            @endforeach
