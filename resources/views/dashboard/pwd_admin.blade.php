...
@section('title', 'PWD Admin Dashboard')
@section('content')
    <div class="w-full grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        >   
            <div class="w-full flex items-center gap-x-20">
                <img src="{{asset('/images/icons/pwd.svg')}}" alt="Person Icon" class="object-contain w-20 h-auto">
        ...
        >   
            <div class="w-full flex items-center gap-x-20">
                <img src="{{asset('/images/icons/male.png')}}" alt="Senior Icon" class="object-contain w-20 h-20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <div class="bg-white p-4 rounded-xl shadow-md text-center">
            @if($current_user->role === 'pwd_admin')
            ...
            <canvas id="pwd_barangayChart"></canvas>
        </div>
